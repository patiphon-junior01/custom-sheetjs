...
- คำนวณ **อัตโนมัติ** ทุกครั้งที่ข้อมูลเปลี่ยน โดยประมวลผลด้วย **Topological Sort** อ้างอิงตามลำดับก่อนหลัง
- **ป้องกันวงจรลูป (Circular Dependency):** หากเซลล์อ้างอิงสูตรกันเป็นวงกลม (เช่น A โยงไป B, B โยงไป A) ระบบจะแสดงผลเป็น `#CYCLE!` เพื่อป้องกัน Infinite Loop ทันที
...
| `Enter`               | บันทึกค่าและเลื่อนลงล่าง / เข้าโหมดแก้ไข |
| `Shift + Enter`       | บันทึกค่าและเลื่อนขึ้นบน             |
| `Escape`              | ยกเลิกแก้ไข / ปิดค้นหา               |
| `Tab`                 | บันทึกค่าและเลื่อนไปขวา              |
| `Shift + Tab`         | บันทึกค่าและเลื่อนไปซ้าย             |
